...
```json
{
  "mcpServers": {
    "letzai": {
      "command": "node",
      "args": ["C:\\Letz AI\\mcp\\letzai\\build\\index.js"],
      "env": {
...
```json
{
  "mcpServers": {
    "letzai": {
      "command": "node",
      "args": ["/home/your-username/LetzAI/mcp/letzai/build/index.js"],
      "env": {
        "LETZAI_API_KEY": "<Your Letz AI API Key>"
      }
    }
...
```json
{
  "mcpServers": {
    "letzai": {
      "command": "node",
      "args": ["/Users/your-username/LetzAI/mcp/letzai/build/index.js"],
      "env": {
        "LETZAI_API_KEY": "<Your Letz AI API Key>"
      }
    }
