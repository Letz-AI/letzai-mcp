...
export const setResources = async (server) => {
            ...
            resources: [
                {
                    ...
                    description: "Detailed informations how you obtain a subscription from LetzAI with an Api Key with access to the public api",
                    mimeType: "text/plain",
                },
                {
